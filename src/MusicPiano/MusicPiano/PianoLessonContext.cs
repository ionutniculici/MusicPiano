...
public partial class PianoLessonContext : DbContext
{
    ...
    public virtual DbSet<LessonNew> LessonNews { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<LessonNew>(entity =>
        {
            entity.ToTable("LessonNew");
        ...
        modelBuilder.Entity<LessonPrerequisite>(entity =>
        {
            ...
            entity.HasOne(d => d.IdLessonNavigation).WithOne(p => p.LessonPrerequisite)
                .HasForeignKey<LessonPrerequisite>(d => d.IdLesson)
        ...
        modelBuilder.Entity<UserLesson>(entity =>
        {
            ...
            entity.HasOne(d => d.IdLesson1).WithMany(p => p.UserLessons)
                .HasForeignKey(d => d.IdLesson)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_UserLesson_LessonNew1");
